...
# Documentation:
# @raycast.author KhulnaSoft
# @raycast.authorURL https://raycast.com/KhulnaSoft
...
if __name__ == "__main__":
    try:
        repos = g.get_user('khulnasoft').get_repos()
        orphaned_repos = []
        ...
        if repos is not None:
            ...
            for repo in os.listdir(f'{ Path.home() }/projects/khulnasoft'):
            ...
            if len(orphaned_repos) > 0:
                ...
                for repo in orphaned_repos:
                    os.system(f'rm -rf { Path.home() }/projects/khulnasoft/{repo}')
